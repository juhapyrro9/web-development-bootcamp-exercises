...
app.post("/submit", (req, res) => {
  ...
  let RandomNumberForAdj = Math.floor(Math.random() * adj.length);
  let RandomNumberForNoun = Math.floor(Math.random() * noun.length);
  let theAdjective = adj[RandomNumberForAdj];
  let theNoun = noun[RandomNumberForNoun];

  const data = { param1: theAdjective, param2: theNoun };
